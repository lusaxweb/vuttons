...
var setVar = function setVar(propertyName, value, el) {
  if (!el) {
    ...
    console.log("--vut-".concat(propertyName), value);
...
var submit_component = normalizeComponent(
  ...
  submitvue_type_template_id_757a14be_render,
  submitvue_type_template_id_757a14be_staticRenderFns,
  false,
  null,
  null,
  null
...
/******/ });
//# sourceMappingURL=vuttons.common.js.map